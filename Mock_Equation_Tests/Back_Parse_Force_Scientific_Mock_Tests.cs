...
{
    public class Back_Parse_Force_Scientific_Mock_Tests
    {
        /// <summary>
        /// Returns given number in given numeral system as string representation in
        /// scientific notation.
        /// </summary>
        public string Back_Parse_Force_Scientific_Mock_Test(double number, sbyte numeral_System_Type)
        {
            Back_Parser_Mocked_Fascede Back_Parser = new Back_Parser_Mocked_Fascede(Number_Notation.Force_Scientific, numeral_System_Type, ",");
        ...
        /// <summary>
        /// Tests back parsing numbers to decimal representations of scientific notation.
        /// </summary>
        [Theory]
        ...
        public void Back_Parse_Decimal(double number, string expected_Output)
        {
            ...
            string output = Back_Parse_Force_Scientific_Mock_Test(number, 10);
